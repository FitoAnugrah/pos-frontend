  ...
  return (
    <div className="min-h-screen w-full bg-[#1A1D20] font-sans flex justify-center">
      <div className="min-h-screen flex flex-col items-center justify-center w-full max-w-[440px] bg-[#F4F7FB] shadow-2xl overflow-y-auto px-5 py-10 relative">
        ...
        {/* Main Card */}
        <div className="w-full bg-white rounded-[26px] p-6 sm:p-8 shadow-[0_18px_45px_rgba(115,152,181,0.08)] border border-gray-100 flex flex-col items-center relative z-10">
          
          {/* Logo Box */}
          <div className="w-[56px] h-[56px] bg-[#0E7BD3] rounded-[16px] flex items-center justify-center mb-5 shadow-[0_14px_24px_rgba(14,123,211,0.25)]">
          ...
          <h1 className="text-[18px] font-black text-[#0F2035] tracking-tight mb-6">POS A'I</h1>
          
          {/* Typo fixed from 'Ũata' to 'Kata' */}
          <h2 className="text-[22px] font-black tracking-tight text-[#17324D] mb-3 text-center">Atur Ulang Kata Sandi</h2>
          
          <p className="text-center text-[13px] text-[#607C97] leading-relaxed mb-8 px-2 max-w-[280px]">
            Masukkan alamat email aman Anda dan kami akan mengirimkan tautan pemulihan akses vault.
          </p>

          <form onSubmit={handleSubmit} className="w-full">
            <div className="mb-6">
              <label className="mb-2 block text-[11px] font-extrabold uppercase tracking-[0.18em] text-[#304154]">
                Alamat Email Bisnis
              </label>
              <div className="bg-[#EAF4FB] rounded-[14px] flex items-center px-4 py-3.5 focus-within:ring-2 focus-within:ring-[#0E7BD3]/30 transition-all text-[#23425D]">
            ...
            <button 
              type="submit"
              className="w-full bg-[#0E7BD3] hover:bg-[#0c6bb8] text-white font-bold py-4 px-4 rounded-[14px] transition-colors duration-200 shadow-[0_14px_24px_rgba(14,123,211,0.25)] flex items-center justify-center space-x-2 text-[15px]"
            >
          ...
          {/* Divider Line */}
          <div className="w-full h-[1px] bg-[#EAF1F8] my-7"></div>
          
          {/* Back to Login */}
          <button 
            type="button"
            onClick={() => onNavigate && onNavigate('masuk')}
            className="flex items-center text-[#0A76CA] font-bold text-[14px] hover:underline"
          >
        ...
        <div className="mt-8 flex items-center space-x-2 text-[#8B9DB0]">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
            <path d="M9 12l2 2 4-4" />
          </svg>
          <span className="text-[10.5px] font-bold uppercase tracking-[0.15em]">Protokol Keamanan Perusahaan</span>
        </div>
