...
export default function TerminalCard() {
  return (
    <div className="w-full">
      <button className="w-full text-left relative overflow-hidden bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-6 shadow-lg border border-slate-700/50 transition-all duration-300 hover:shadow-xl hover:scale-[1.01] active:scale-[0.98]">
        {/* Subtle sleek accent */}
