...
function InputRow({ label, value, icon, onChange, type = "text" }) {
  return (
    <div>
      ...
      <div className="flex items-center gap-3 rounded-xl bg-slate-50 px-4 py-3.5 text-slate-800 transition-all w-full focus-within:bg-white focus-within:ring-2 focus-within:ring-blue-500 focus-within:outline-none">
        <span className="flex h-5 w-5 items-center justify-center text-slate-400 shrink-0">{icon}</span>
        <input 
          type={type}
          value={value}
          onChange={onChange}
      ...
      <div className="w-full max-w-3xl mx-auto flex flex-col pb-12">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="relative">
            ...
            <label
              className="absolute bottom-0 right-0 flex h-10 w-10 cursor-pointer items-center justify-center rounded-full border-4 border-slate-50 bg-blue-600 text-white shadow-md hover:bg-blue-700 transition-colors"
            >
